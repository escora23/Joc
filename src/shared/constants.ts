...
export const UNIT_DEFS: Record<UnitType, UnitDef> = {
  ...
  [U.FighterSquadron]: { type: U.FighterSquadron, id: 'fighterSquadron', cost: 200_000, producedBy: S.Airbase, speed: 1.1, maxHp: 400, airborne: true, command: 'jet' },
  [U.Bomber]: { type: U.Bomber, id: 'bomber', cost: 350_000, producedBy: S.Airbase, speed: 0.7, maxHp: 600, airborne: true, command: null },
  [U.DroneSwarm]: { type: U.DroneSwarm, id: 'droneSwarm', cost: 120_000, producedBy: S.Airbase, speed: 0.65, maxHp: 200, airborne: true, command: null },
  [U.CruiseMissile]: { type: U.CruiseMissile, id: 'cruiseMissile', cost: 300_000, producedBy: S.MissileSilo, speed: 1.6, maxHp: 1, airborne: true, command: null },
  [U.AtomBomb]: { type: U.AtomBomb, id: 'atomBomb', cost: 750_000, producedBy: S.MissileSilo, speed: 1.3, maxHp: 1, airborne: true, command: null },
  [U.HydrogenBomb]: { type: U.HydrogenBomb, id: 'hydrogenBomb', cost: 5_000_000, producedBy: S.MissileSilo, speed: 1.2, maxHp: 1, airborne: true, command: null },
  [U.Mirv]: { type: U.Mirv, id: 'mirv', cost: 25_000_000, producedBy: S.MissileSilo, speed: 1.1, maxHp: 1, airborne: true, command: null },
  [U.MirvWarhead]: { type: U.MirvWarhead, id: 'mirvWarhead', cost: 0, producedBy: -1, speed: 1.5, maxHp: 1, airborne: true, command: null },
  [U.SamInterceptor]: { type: U.SamInterceptor, id: 'samInterceptor', cost: 0, producedBy: S.SamSite, speed: 3.2, maxHp: 1, airborne: true, command: null },
  [U.Train]: { type: U.Train, id: 'train', cost: 0, producedBy: S.Factory, speed: 1.5, maxHp: 1, airborne: false, command: null },
  [U.Shell]: { type: U.Shell, id: 'shell', cost: 0, producedBy: -1, speed: 5.0, maxHp: 1, airborne: true, command: null },
};
