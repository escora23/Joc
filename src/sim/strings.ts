...
const es: Record<string, string> = {
  ...
  'msg.baseFull': 'Base llena: {structureName} no tiene hangares libres',
  ...
  'msg.noProducer': 'Necesitas un(a) {structureName} operativo',
  ...
  'msg.structureCaptured': 'El enemigo ha capturado nuestro(a) {structureName}',
  'msg.structureLost': 'Hemos perdido un(a) {structureName}',
